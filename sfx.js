...
const SFX = {
    ...
    _musicTracks: {
        ...
        scheming: 'https://github.com/Bat0nCH1K/batonchik-app/releases/download/v1.0/Kevin_MacLeod_-_Scheming_Weasel_64951988.mp3',
        aria: 'https://github.com/Bat0nCH1K/batonchik-app/releases/download/v1.0/C418.Aria.Math.mp3',
        speedrun: 'https://github.com/Bat0nCH1K/batonchik-app/releases/download/v1.0/Dream_-_Speedrun_Music_73264908.mp3',
        darkfantasy: 'https://github.com/Bat0nCH1K/batonchik-app/releases/download/v1.0/Dustum_-_dark_fantasy_79987719.mp3',
        interstellar: 'https://github.com/Bat0nCH1K/batonchik-app/releases/download/v1.0/Hans_Zimmer_-_Interstellar_Theme_Song_71652021.mp3',
        joyfulchess: 'https://github.com/Bat0nCH1K/batonchik-app/releases/download/v1.0/joyful_-_chess_79030573.mp3',
        smeshariki: 'https://github.com/Bat0nCH1K/batonchik-app/releases/download/v1.0/Smeshariki_-_Muzyka_pogoni_66371495.mp3',
        asgore: 'https://github.com/Bat0nCH1K/batonchik-app/releases/download/v1.0/undertale_077.ASGORE.mp3',
        hopes: 'https://github.com/Bat0nCH1K/batonchik-app/releases/download/v1.0/undertale_087.Hopes.and.Dreams.mp3',
    },
